          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-14 md:gap-20 items-start">
            <div className="flex flex-col gap-10">
              ...
              <MaskedLines
                as="h2"
                trigger="in-view"
                lines={[<>Let's Build the Path Forward.</>]}
                className="-mt-4 t-h2 text-off-white"
              />

              <FadeRise trigger="child" as="div">
                <p className="t-lead text-off-white/75 max-w-[56ch]">
                  The market moves fast, but your financial strategy should move faster. Contact us to learn how Golden Road Strategies can provide the executive financial leadership your next phase of growth requires.
                </p>
              </FadeRise>
