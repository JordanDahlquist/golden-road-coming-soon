...
const BRAND_TOKENS: TokenDef[] = [
  { name: "background", cssVar: "--background", value: "hsl(0 3% 8%)", note: "page bg" },
  { name: "charcoal-deep", cssVar: "--charcoal-deep", value: "hsl(0 3% 8%)", note: "deep surface" },
  { name: "charcoal", cssVar: "--charcoal", value: "hsl(30 4% 18%)", note: "elevated surface" },
  { name: "gold", cssVar: "--gold", value: "hsl(42 72% 62%)", note: "hero accent" },
  { name: "off-white", cssVar: "--off-white", value: "hsl(30 11% 97%)", note: "headings" },
...
const RESERVED_TOKENS: TokenDef[] = [
  ...
  { name: "silver", cssVar: "--silver", value: "hsl(30 8% 90%)" },
  { name: "gold-light", cssVar: "--gold-light", value: "hsl(42 72% 72%)" },
  { name: "gold-dark", cssVar: "--gold-dark", value: "hsl(42 72% 52%)" },
  { name: "foreground", cssVar: "--foreground", value: "hsl(30 11% 97%)" },
  { name: "card", cssVar: "--card", value: "hsl(30 4% 12%)" },
  { name: "card-foreground", cssVar: "--card-foreground", value: "hsl(30 11% 97%)" },
  { name: "popover", cssVar: "--popover", value: "hsl(30 4% 12%)" },
  { name: "popover-foreground", cssVar: "--popover-foreground", value: "hsl(30 11% 97%)" },
  { name: "primary", cssVar: "--primary", value: "hsl(42 72% 62%)" },
  { name: "primary-foreground", cssVar: "--primary-foreground", value: "hsl(0 3% 8%)" },
  { name: "secondary", cssVar: "--secondary", value: "hsl(30 4% 18%)" },
  { name: "secondary-foreground", cssVar: "--secondary-foreground", value: "hsl(30 11% 97%)" },
  { name: "muted", cssVar: "--muted", value: "hsl(30 4% 18%)" },
  { name: "accent", cssVar: "--accent", value: "hsl(42 72% 62%)" },
  { name: "accent-foreground", cssVar: "--accent-foreground", value: "hsl(0 3% 8%)" },
  ...
  { name: "ring", cssVar: "--ring", value: "hsl(42 72% 62%)" },
